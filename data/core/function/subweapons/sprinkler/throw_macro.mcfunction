...
summon armor_stand ^ ^ ^2 {Tags:["bomb$(bombNum)","bomb","owner$(num)"],Invisible:true,Silent:true,Small:false,data:{team:$(team),owner:$(num),bombNum:$(bombNum),type:"sprinkler",color:$(color)},attributes:[{id:"minecraft:gravity",base:0.1}]}
