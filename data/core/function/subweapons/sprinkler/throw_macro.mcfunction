...
summon armor_stand ^ ^ ^2 {Tags:["bomb$(bombNum)","bomb","owner$(num)"],Invisible:true,Silent:true,Small:false,data:{team:$(team),owner:$(num),bombNum:$(bombNum),type:"sprinkler"},attributes:[{id:"minecraft:gravity",base:0.1}]}
rotate @n[type=armor_stand] facing entity @p
...
$summon item_display ~ ~ ~ {Tags:["bombDisplay","bn$(bombNum)"],data:{bNum:$(bombNum),team:$(team),owner:$(num),color:$(color),type:"sprinkler"},item_display:"ground",teleport_duration:1,\
                            transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0.0f,1.5f,0f],scale:[1.0,1.0,1.0]},\
