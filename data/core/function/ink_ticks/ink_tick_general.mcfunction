...
#スペシャルポイント処理
$function core:actions/add_specialpoint {fx:-0.3,fy:-2,fz:-0.3,tx:0.3,ty:0,tz:0.3,color:"$(color)",owner:$(owner)}

#塗り
$fill ~-0.3 ~-2 ~-0.3 ~0.3 ~ ~0.3 $(color)_concrete replace #core:can_inking
