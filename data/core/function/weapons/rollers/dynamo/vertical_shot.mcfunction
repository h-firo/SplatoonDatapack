...
$execute positioned ~ ~1.6 ~ run \
summon armor_stand ^ ^ ^0.7 {Tags:["shot$(team)","ink","owner$(num)","general"],Invisible:true,Silent:true,data:{team:$(team),owner:$(num),damage:$(Damage),shotNum:$(shotNum),damageAT:$(DamageAT)},attributes:[{id:"minecraft:gravity",base:$(Gravity)}]}
$execute positioned ~ ~1.6 ~ run \
summon armor_stand ^ ^ ^0.5 {Tags:["shot$(team)","ink","owner$(num)","general"],Invisible:true,Silent:true,data:{team:$(team),owner:$(num),damage:$(Damage),shotNum:$(shotNum),damageAT:$(DamageAT)},attributes:[{id:"minecraft:gravity",base:$(Gravity)}]}
$execute positioned ~ ~1.6 ~ run \
summon armor_stand ^ ^ ^0.3 {Tags:["shot$(team)","ink","owner$(num)","general"],Invisible:true,Silent:true,data:{team:$(team),owner:$(num),damage:$(Damage),shotNum:$(shotNum),damageAT:$(DamageAT)},attributes:[{id:"minecraft:gravity",base:$(Gravity)}]}
